...
<body>
    <p style="text-align: left">Email: {{ $money_transfers[0]->sendUser->email }}</p>
    <p style="text-align: left">Id Number: {{ $money_transfers[0]->sendUser->id_number }}</p>
    <p style="text-align: left">Phone Number: {{ $money_transfers[0]->sendUser->phone_number }}</p>
    <p style="text-align: left"> Address: {{ $money_transfers[0]->sendUser->address }}</p>
    <hr>
