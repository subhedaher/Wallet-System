    ...
    <main class="app-wrapper">
        ...
        <div class="sidebar-wrapper group">
            ...
            <div class="logo-segment">
                <a class="flex items-center" href="{{ route('cms.index') }}">
                    ...
                    <span
                        class="ltr:ml-3 rtl:mr-3 text-xl font-Inter font-bold text-slate-900 dark:text-white">Dashboard</span>
                </a>
                <!-- Sidebar Type Button -->
      ...
      opacity-0">
            ...
            <div class="sidebar-menus bg-white dark:bg-slate-800 py-2 px-4 h-[calc(100%-80px)] overflow-y-auto z-50"
                ...
                <ul class="sidebar-menu">
                    ...
                    @include('cms.components.li_Item', [
                        'label' => 'Home',
                    ...
                    @canany(['Create-Admin', 'Read-Admins'])
                        @include('cms.components.nav_Item', [
                            'lable' => 'Admins',
                            'icon' => 'eos-icons:admin',
                            'options' => [
                                [
                                    'lable' => 'Create',
                                    'route' => route('admins.create'),
                    ...
                    @canany(['Create-Payment-Category', 'Read-Payment-Categories'])
                        @include('cms.components.nav_Item', [
                            'lable' => 'Payment Categories',
                            'icon' => 'bxs:category-alt',
                            'options' => [
                                [
                                    'lable' => 'Create',
                                    'route' => route('payment-categories.create'),
                                    'routeName' => 'payment-categories.create',
                                    'routeEdit' => '',
                                    'routeDeleted' => '',
                                    'permission' => 'Create-Payment-Category',
                                ],
                                [
                                    'lable' => 'Read',
                                    'route' => route('payment-categories.index'),
                                    'routeName' => 'payment-categories.index',
                                    'routeEdit' => 'payment-categories.edit',
                                    'routeDeleted' => 'paymentCategories.deleted',
                                    'permission' => 'Read-Payment-Categories',
                                ],
                            ],
                        ])
                    @endcanany

                    @canany(['Create-Payment-Provider', 'Read-Payment-Providers'])
                        @include('cms.components.nav_Item', [
                            'lable' => 'Payment Providers',
                            'icon' => 'carbon:location-company-filled',
                            'options' => [
                                [
                                    'lable' => 'Create',
                                    'route' => route('payment-providers.create'),
                                    'routeName' => 'payment-providers.create',
                                    'routeEdit' => '',
                                    'routeDeleted' => '',
                                    'permission' => 'Create-Payment-Provider',
                                ],
                                [
                                    'lable' => 'Read',
                                    'route' => route('payment-providers.index'),
                                    'routeName' => 'payment-providers.index',
                                    'routeEdit' => 'payment-providers.edit',
                                    'routeDeleted' => 'paymentProviders.deleted',
                                    'permission' => 'Read-Payment-Providers',
                                ],
                            ],
                        ])
                    @endcanany

                    @canany(['Create-Shipping-Point', 'Read-Shipping-Points'])
                        @include('cms.components.nav_Item', [
                            'lable' => 'Shipping Points',
                            'icon' => 'map:moving-company',
                            'options' => [
                                [
                                    'lable' => 'Create',
                                    'route' => route('shipping-points.create'),
                                    'routeName' => 'shipping-points.create',
                                    'routeEdit' => '',
                                    'routeDeleted' => '',
                                    'permission' => 'Create-Shipping-Point',
                                ],
                                [
                                    'lable' => 'Read',
                                    'route' => route('shipping-points.index'),
                                    'routeName' => 'shipping-points.index',
                                    'routeEdit' => 'shipping-points.edit',
                                    'routeDeleted' => 'shippingPoints.deleted',
                                    'permission' => 'Read-Shipping-Points',
                                ],
                            ],
                        ])
                    @endcanany
                    ...
                    @canany(['User-Shipping'])
                        @include('cms.components.nav_Item', [
                            'lable' => 'Recharge Balances',
                            'icon' => 'mdi:money',
                            'options' => [
                                [
                                    'lable' => 'Search',
                                    'route' => route('recharge.index'),
                                    'routeName' => 'recharge.index',
                                    'routeEdit' => '',
                                    'routeDeleted' => '',
                                    'permission' => 'User-Shipping',
                                ],
                            ],
                        ])
                    @endcanany
                    ...
                    @include('cms.components.nav_Item', [
                        ...
                        'options' => [
                            [
                                'lable' => 'All',
                                'route' => route('all.transaction'),
                                'routeName' => 'all.transaction',
                                'routeEdit' => '',
                                'routeDeleted' => '',
                                'permission' => 'Transaction-All',
                            ],
                            [
                                'lable' => 'Shipping Point',
                                'route' => route('shippingPointAdmin.transaction'),
                                'routeName' => 'shippingPointAdmin.transaction',
                                'routeEdit' => '',
                                'routeDeleted' => '',
                                'permission' => 'Transaction-Shipping-Points-Admin',
                            ],
                            [
                                'lable' => 'Shipping Point',
                                'route' => route('shippingPoint.transaction'),
                                'routeName' => 'shippingPoint.transaction',
                                'routeEdit' => '',
                                'routeDeleted' => '',
                                'permission' => 'Transaction-Shipping-Points',
                            ],
                            [
                                'lable' => 'Payment Provider',
                                'route' => route('paymentProvider.transaction'),
                                'routeName' => 'paymentProvider.transaction',
                                'routeEdit' => '',
                                'routeDeleted' => '',
                                'permission' => 'Transaction-Payment-Providers',
                            ],
                            [
                                'lable' => 'User',
                                'route' => route('user.transaction'),
                                'routeName' => 'user.transaction',
                                'routeEdit' => '',
                                'routeDeleted' => '',
                                'permission' => 'Transaction-Users',
                            ],
                        ],
                    ])
                </ul>
      ...
      rounded-full text-[20px] flex flex-col items-center justify-center"
        ...
        justify-center rounded-full text-white z-[99]">
                                            {{ auth()->user()->unreadNotifications()->count() !== 0? auth()->user()->unreadNotifications()->count(): 0 }}</span>
                                    </button>
      ...
      dark:bg-slate-800 border dark:border-slate-700 !top-[23px] rounded-md overflow-hidden lrt:origin-top-right rtl:origin-top-left">
                                        <div class="flex items-center justify-between py-4 px-4">
                                            ...
                                            <a class="text-xs font-Inter font-normal underline text-slate-500 dark:text-white"
                                                href="{{ route('readAllNotifications') }}">See All</a>
                                        </div>
                                        <div class="" role="none">
      ...
      inline-flex items-center"
                                        ...
                                        <span
                                            class="flex-none text-slate-600 dark:text-white text-sm font-normal items-center lg:flex hidden overflow-hidden text-ellipsis whitespace-nowrap">{{ explode(' ', auth()->user()->full_name)[0] }}</span>
      ...
      overflow-hidden">
            ...
            dark:text-white font-normal">
                                            ...
                                            <li>
                                                <a href="{{ route('auth.editUser') }}"
                                                    class="block px-4 py-2 hover:bg-slate-100 dark:hover:bg-slate-600 dark:hover:text-white font-inter text-sm text-slate-600
            dark:text-white font-normal">
                                                    <iconify-icon icon="iconamoon:profile-fill"
                                                        class="relative top-[2px] text-lg ltr:mr-1 rtl:ml-1"></iconify-icon>
                                                    <span class="font-Inter">Edit Profile</span>
                                                </a>
                                            </li>
                                            <li>
            ...
            dark:text-white font-normal">
                                                    <iconify-icon icon="mdi:password"
                                                        class="relative top-[2px] text-lg ltr:mr-1 rtl:ml-1"></iconify-icon>
                                                    <span class="font-Inter">Edit Password</span>
                                                </a>
                                            </li>
                                            <li>
