    ...
    <div class=" space-y-5">
        <div class="card">
            <header class=" card-header noborder">
                <h4 class="card-title">Read Admins Deleted
                </h4>
            </header>
                        ...
                        <div class="overflow-hidden ">
                            ...
                            : activate to sort column ascending"
                                        ...
                                        <tbody
                                            ...
                                            @foreach ($adminsDeleted as $admin)
                                                    ...
                                                    <td class="table-td ">
                                                        <div class="flex space-x-3 rtl:space-x-reverse">
                                                            <button class="action-btn" type="button"
                                                                onclick="restoreAdmin('{{ route('admins.restore', $admin->id) }}' , this)">
                                                                <iconify-icon icon="fa-solid:trash-restore"
                                                                    style="color: white;"></iconify-icon>
                                                            </button>
                                                            <button class="action-btn" type="button"
                                                                onclick="forceDeleteAdmin('{{ route('admins.forceDelete', $admin->id) }}' , this)">
