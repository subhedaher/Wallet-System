    ...
    <div class="card">
        <div class="card-body flex flex-col p-6">
            <header class="flex mb-5 items-center border-b border-slate-100 dark:border-slate-700 pb-5 -mx-6 px-6">
                <div class="flex-1">
                    <div class="card-title text-slate-900 dark:text-white">Create Payment Provider</div>
                </div>
            </header>
            <div class="card-text h-full ">
                <form class="space-y-4" id="form-data">
                    ...
                    <div class="input-area">
                        ...
                        <select id="paymentCategory" class="form-control">
                            ...
                            @foreach ($paymentCategories as $paymentCategory)
                                <option value="{{ $paymentCategory->id }}" class="dark:bg-slate-700">
                    ...
                    <input type="button" class="btn inline-flex justify-center btn-dark" onclick="addPaymentProvider()"
...
@section('scripts')
    <script>
        function addPaymentProvider() {
            ...
            axios.post('{{ route('payment-providers.store') }}', formData)
